...
namespace SierraBreeze
{
        ...
        if (foregroundColor.isValid())
        {
            ...
            case DecorationButtonType::Maximize:
            {
                if (isChecked())
                {
                    ...
                    QPen max_pen(backgroundColor);
                    max_pen.setCapStyle(Qt::RoundCap);
                    max_pen.setJoinStyle(Qt::MiterJoin);
                    max_pen.setWidthF(1.1 * qMax((qreal)1.0, 20 / width));
    ...
    QColor Button::foregroundColor() const
    {
        ...
        //         else
        //             return KColorUtils::mix(titleBarColor, QColor(230, 230, 230), m_opacity);
        //     }
        //     if (titleBarColor.name(QColor::HexRgb) < "#777777")
        //     {
        //         return KColorUtils::mix(titleBarColor,QColor(41, 43, 50), m_opacity);
    ...
    QColor Button::backgroundColor() const
    {
        ...
        if (isPressed())
        {
            ...
            if (type() == DecorationButtonType::Close)
                ...
                return KColorUtils::mix(QColor(230, 230, 230), d->titleBarColor(), 0.3);
        }
        else if ((type() == DecorationButtonType::KeepBelow || type() == DecorationButtonType::KeepAbove || type() == DecorationButtonType::Shade) && isChecked())
        {
        ...
        //        if (titleBarColor.name(QColor::HexRgb) < "#777777")
        //     {
        //         return KColorUtils::mix(QColor(230, 230, 230), titleBarColor, m_opacity);
        //     }
        //     else
        //     {
